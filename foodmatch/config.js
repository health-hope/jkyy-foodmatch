...
var config = {
         ...
         */
        signUrl: 'https://api.hbox.jiankangyouyi.com/ego-gw/sign.do?appId=5b33941b84274a0aa482e105',
    ...
    /****存在用户信息处理 ******
         * 1.访问地址：/foodmatch/index.html?openIdItem=XXXXXX&foodMatchtype=XXXXXX
         * 2. 参数说明：
         *   a) openIdItem                 openId      必须
         *   b）foodMatchtype              type类型     必须
         *  食物type类型
         *0 高血脂
         *2 肥胖
         *3 痛风
